-- ============================================================================
-- Remediated: Snowflake -> Snowflake | source: 00_input/SFissuetime.sql
-- Pipeline: snowflake2snowflake ICM | stage 03_fix | 2026-07-24
-- Semantic ground truth: 00_input/SFissuetime.teradata.sql
--
...
--
-- PURPOSE
-- A full-outer-join staging load that carries both legacy and new flight-leg
-- values.
--
-- OPEN SME QUESTIONS
