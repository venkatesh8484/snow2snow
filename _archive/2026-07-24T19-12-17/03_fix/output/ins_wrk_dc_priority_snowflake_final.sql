...
-- Source of truth: 06_explain/output/semantic_ins_wrk_dc_priority_snowflake.md
--
-- PURPOSE
-- A large ranked-coupon priority load into wrk_dc_priority with several joins
-- and a final QUALIFY dedup.
--
-- OPEN SME QUESTIONS
