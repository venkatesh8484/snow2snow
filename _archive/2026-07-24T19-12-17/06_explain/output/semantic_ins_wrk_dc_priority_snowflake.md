# Semantic explanation — `ins_wrk_dc_priority_snowflake`

## 1. Purpose
A large ranked-coupon priority load into wrk_dc_priority with several joins and a final QUALIFY dedup.
